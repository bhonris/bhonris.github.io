    ...
    <>
      ...
      <div className="card">
        ...
        {/* <button className="card-button">
           <a href="https://www.weeboon.com/en/campaign/help-physics-teacher-ross-kuhl-fight-cancer">
             Donate here
           </a>
         </button> */}
      </div>
      <div className="footer">
        <button
          ...
          onClick={() =>
            window.open(
              "https://www.weeboon.com/en/campaign/help-physics-teacher-ross-kuhl-fight-cancer"
            )
          }
        >
          Donate here
